...
- If you change `name`, `description`, `icons`, or other manifest metadata after upload, you need to update the manifest, increase the version, and upload a new ZIP.
- Keep the listing text factual. Avoid exaggerated marketing claims or keyword stuffing.
- Make sure the screenshots and icon match the current extension behavior and branding.

## Official References

- Chrome extension icons: https://developer.chrome.com/docs/extensions/develop/ui/configure-icons
- Chrome Web Store prep: https://developer.chrome.com/docs/webstore/prepare
